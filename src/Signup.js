...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`http://54.252.244.9:5000/signup/${formData.name}/${formData.userId}/${formData.password}/${formData.email}/${formData.address}/${formData.phoneNumber}/${formData.emergencyContacts[0]}/${formData.emergencyContacts[1]}/${formData.emergencyContacts[2]}/${formData.aadhaarNumber}`);
